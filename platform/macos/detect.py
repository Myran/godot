...
def configure(env: "SConsEnvironment"):
    ...
    if env["arch"] == "arm64":
        ...
        env.Append(ASFLAGS=["-arch", "arm64", "-mmacosx-version-min=15.7"])
        env.Append(CCFLAGS=["-arch", "arm64", "-mmacosx-version-min=15.7"])
        env.Append(LINKFLAGS=["-arch", "arm64", "-mmacosx-version-min=15.7"])
    elif env["arch"] == "x86_64":
        print("Building for macOS 10.13+.")
        env.Append(ASFLAGS=["-arch", "x86_64", "-mmacosx-version-min=15.7"])
        env.Append(CCFLAGS=["-arch", "x86_64", "-mmacosx-version-min=15.7"])
        env.Append(LINKFLAGS=["-arch", "x86_64", "-mmacosx-version-min=15.7"])
