...
windows-native-sentry-release:
    ...
    cmake -S {{WIN_SENTRY_PATH}}\modules\sentry-native -B {{WIN_SENTRY_PATH}}\build\windows-msvc-release -DCMAKE_BUILD_TYPE=Release -DSENTRY_BUILD_SHARED_LIBS=ON -DSENTRY_BUILD_TESTS=OFF -DSENTRY_BUILD_EXAMPLES=OFF -DSENTRY_BACKEND=crashpad -A x64 -DCMAKE_SYSTEM_PROCESSOR=AMD64
...
windows-native-sentry-debug:
    ...
    cmake -S {{WIN_SENTRY_PATH}}\modules\sentry-native -B {{WIN_SENTRY_PATH}}\build\windows-msvc-debug -DCMAKE_BUILD_TYPE=Debug -DSENTRY_BUILD_SHARED_LIBS=ON -DSENTRY_BUILD_TESTS=OFF -DSENTRY_BUILD_EXAMPLES=OFF -DSENTRY_BACKEND=crashpad -A x64 -DCMAKE_SYSTEM_PROCESSOR=AMD64
