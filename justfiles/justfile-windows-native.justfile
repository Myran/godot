...
windows-native-sentry-release:
    ...
    cd /d "{{WIN_SENTRY_PATH}}\build\windows-msvc-release" && cmake ..\..\modules\sentry-native -DCMAKE_BUILD_TYPE=Release -DSENTRY_BUILD_SHARED_LIBS=ON -DSENTRY_BUILD_TESTS=OFF -DSENTRY_BUILD_EXAMPLES=OFF -DSENTRY_BACKEND=crashpad -G "Visual Studio 17 2022" -A x64
...
windows-native-sentry-debug:
    ...
    cd /d "{{WIN_SENTRY_PATH}}\build\windows-msvc-debug" && cmake ..\..\modules\sentry-native -DCMAKE_BUILD_TYPE=Debug -DSENTRY_BUILD_SHARED_LIBS=ON -DSENTRY_BUILD_TESTS=OFF -DSENTRY_BUILD_EXAMPLES=OFF -DSENTRY_BACKEND=crashpad -G "Visual Studio 17 2022" -A x64
