...
windows-native-sentry-release:
    ...
    cmake -S {{WIN_SENTRY_PATH}}\modules\sentry-native -B {{WIN_SENTRY_PATH}}\build\windows-msvc-release -DSENTRY_BUILD_SHARED_LIBS=ON -DSENTRY_BUILD_TESTS=OFF -DSENTRY_BUILD_EXAMPLES=OFF -DSENTRY_BACKEND=crashpad -A x64 -T host=x64 -DCMAKE_ASM_MASM_COMPILER=ml64.exe
...
windows-native-sentry-debug:
    ...
    cmake -S {{WIN_SENTRY_PATH}}\modules\sentry-native -B {{WIN_SENTRY_PATH}}\build\windows-msvc-debug -DSENTRY_BUILD_SHARED_LIBS=ON -DSENTRY_BUILD_TESTS=OFF -DSENTRY_BUILD_EXAMPLES=OFF -DSENTRY_BACKEND=crashpad -A x64 -T host=x64 -DCMAKE_ASM_MASM_COMPILER=ml64.exe
