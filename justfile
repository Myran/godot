...
import "justfiles/justfile-backlog.justfile"
...
help-build:
    ...
    @echo ""
    @echo "🎯 C++ DEVELOPMENT WORKFLOW (RECOMMENDED)"
    @echo "=========================================="
    @echo "🔧 just cpp-dev                      # ⭐ ONE-COMMAND WORKFLOW (Recommended)"
    @echo "   Complete C++ development pipeline (3 steps in 1 command):"
    @echo "   1. just build-android-templates     # Build C++ → .aar (3-15 min)"
    @echo "   2. just install-android-template    # Install template"
    @echo "   3. just fastbuild-android           # Package + deploy (30-60 sec)"
    @echo ""
    @echo "📋 Manual Workflow (Alternative):"
    ...
    @echo ""
    @echo "🚀 Use Cases:"
    @echo "   • Firebase SDK modifications"
    @echo "   • Custom C++ module development"
    @echo "   • Native library integration"
    @echo ""
    ...
    @echo "just cpp-dev                     # ⭐ C++ development workflow (one command)"
