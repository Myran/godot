...
help-debug:
    ...
    @echo ""
    @echo "@ SYMBOL SYSTEM (NEW)"
    @echo "===================="
    @echo "just test-android test-all             # ⭐ Run ALL *-all test suites automatically"
    ...
    @echo ""
    @echo "@ SYMBOL BENEFITS:"
    @echo "• Automatic Discovery: New *-all lists included automatically"
    @echo "• No Duplication: Configs appearing in multiple lists deduplicated"
    @echo "• Circular Protection: Built-in circular dependency detection"
