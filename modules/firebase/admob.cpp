...
void FirebaseAdmob::_bind_methods() {
    ...
    ADD_SIGNAL(MethodInfo("banner_loading_result",PropertyInfo(Variant::BOOL,"result")));
    ADD_SIGNAL(MethodInfo("interstitial_loading_result",PropertyInfo(Variant::BOOL,"result")));
    ADD_SIGNAL(MethodInfo("rewarded_loading_result",PropertyInfo(Variant::BOOL,"result")));
    ADD_SIGNAL(MethodInfo("banner_state",PropertyInfo(Variant::INT,"state")));
    ADD_SIGNAL(MethodInfo("interstitial_state",PropertyInfo(Variant::INT,"state")));
    ADD_SIGNAL(MethodInfo("rewarded_state",PropertyInfo(Variant::INT,"state")));
