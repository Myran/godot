...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 BattleRules class created with STATIC methods only
- [x] #2 Core position and targeting rules implemented (get_ally_positions get_enemy_positions count_allies_alive count_enemies_alive)
- [x] #3 Multi-target operations implemented (deal_damage_to_random_enemies grant_bonuses_to_all_allies)
- [x] #4 All methods use BattleContext as first parameter with proper typing
- [x] #5 Methods follow exact signatures from architecture doc-001
- [x] #6 Class has no instance state or constructor
- [x] #7 Unit tests created with 90%+ code coverage for all static methods
- [x] #8 Performance benchmark validates static method efficiency
