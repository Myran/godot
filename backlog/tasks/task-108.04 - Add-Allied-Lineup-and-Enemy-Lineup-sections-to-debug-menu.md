...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Debug menu displays 'Allied Lineup' section
- [ ] #2 Debug menu displays 'Enemy Lineup' section  
- [ ] #3 Both sections list all available saved lineups with 'line-' prefix
- [ ] #4 Selecting lineup from Allied section loads into allied slot
- [ ] #5 Selecting lineup from Enemy section loads into enemy slot
- [ ] #6 Same lineup files appear in both sections for maximum flexibility
- [ ] #7 Sections display lineup names in user-friendly format (without technical prefixes)
- [ ] #8 Menu sections integrate with existing debug menu layout and styling
- [ ] #9 Menu sections update dynamically when new lineups are saved
<!-- AC:END -->
