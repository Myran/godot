...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Core debug framework extracted as standalone addon
- [ ] #2 Addon can be installed in fresh Godot project
- [ ] #3 GameTwo works with debug system as addon (no regression)
- [ ] #4 Production builds exclude addon completely
- [ ] #5 Documentation for addon usage and extension
- [ ] #6 Example project demonstrating addon usage
- [ ] #7 GitHub repository ready for open source release
