...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 #1 GodotSteam GDExtension integrated and initializing
- [ ] #2 #2 Steam session tickets generated successfully
- [ ] #3 #3 Backend validates tickets with Steam Web API
- [ ] #4 #4 Firebase custom tokens created from validated tickets
- [ ] #5 #5 signInWithCustomToken() working in C++ module
- [ ] #6 #6 GDScript service layer for Steam auth
- [ ] #7 #7 Account linking (Steam + existing Firebase user)
- [ ] #8 #8 Debug actions for testing Steam auth flow
- [ ] #9 #9 Cross-platform support (Windows, Linux, macOS)
