...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Firebase backend tests complete without SIGBUS or SIGSEGV crashes
- [ ] #2 `firebase-backend-batch-1` passes consistently (10/10 runs, individual and suite)
- [ ] #3 `firebase-backend-layer` passes consistently (10/10 runs, individual and suite)
- [ ] #4 `firebase-two-actions-test` passes consistently in comprehensive suite (10/10 runs)
- [ ] #5 No crash signals detected in Android logcat after Firebase tests
- [ ] #6 Auto-quit functionality works safely with Firebase operations
- [ ] #7 Test suite isolation prevents state accumulation (task-216.01)
- [ ] #8 No regression in other Firebase test configurations
