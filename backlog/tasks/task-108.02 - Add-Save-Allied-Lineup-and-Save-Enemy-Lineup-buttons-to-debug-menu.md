...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Debug menu displays both 'Save Allied Lineup' and 'Save Enemy Lineup' buttons
- [ ] #2 Both buttons use simple 'line-' prefix naming convention (e.g. 'line-scenario-name')
- [ ] #3 Buttons follow same user interaction pattern as current save system
- [ ] #4 Buttons trigger lineup data extraction and save with user-provided name
- [ ] #5 Save process provides feedback on success/failure for both button types
- [ ] #6 Buttons are located in same menu section as existing 'Save State' button
- [ ] #7 Buttons are available at same times as existing full save functionality
<!-- AC:END -->
