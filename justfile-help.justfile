...
help:
    ...
    echo "  just test-config-android 'cpp.*'               # All C++ layer tests"
    echo "  just test-config-android '*.firebase.*'        # All Firebase operations"
    echo "  just test-config-android 'Single Action Name'  # Single action test"
    echo "  just test-monitor-android '*.*.error_handling' # Monitor all error handling"
    echo "  just test-quick-android <config>               # Quick test with monitoring"
    echo ""
    echo "  # Test suites with flexible patterns"
    echo "  just test-suite-firebase-android               # Firebase tests (default: firebase-basic)"
    echo "  just test-suite-firebase-android firebase-comprehensive # Advanced Firebase tests"
    echo "  just test-suite-performance-android            # Performance testing"
    echo "  just test-suite-android development-workflow   # Generic: any test list"
    echo "  just test-all-android                          # Complete auto-discovery test suite"
    echo ""
    echo "  # Test list discovery"
    echo "  just list-test-lists                           # List all test lists"
    echo "  just list-test-lists-matching 'firebase-*'     # Find test lists by pattern"
    echo "  💡 Supports: single actions, wildcard patterns (*.layer.*, layer.*), test lists"
    echo ""
    echo "📊 LOG ANALYSIS"
