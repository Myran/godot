...
help:
    ...
    echo "  just config-set <config>             # Set embedded debug config"
    ...
    echo "  💡 <config> can be a config file name OR action name in quotes!"
    echo ""
    echo "🧪 TESTING"
    echo "  just test-config-android <config>       # Automated test (RESTARTS app by default)"
    echo "  just test-monitor-android <config>      # Basic monitoring of debug startup logs"
    echo "  just test-quick-android <config>        # Quick test with monitoring"
    echo "  just test-all-android                   # Run all test configurations"
    echo "  just test-suite-minimal-android         # Quick smoke test"
    echo "  just test-suite-firebase-android        # Firebase-focused testing"
    echo "  💡 <config> can be a config file name OR action name in quotes!"
    echo ""
    echo "📊 LOG ANALYSIS"
