...
func test_tag_list_resizing():
	...
	# Get references to the lists using the updated node paths for the tabbed structure
	var available_list = dock_instance.get_node("VBoxContainer/TabContainer/Tags/TagsContainer/AvailableTagsSection/ScrollContainer/TagsList")
	var active_list = dock_instance.get_node("VBoxContainer/TabContainer/Tags/TagsContainer/TagsSection/ScrollContainer/TagsList")
	var ignored_list = dock_instance.get_node("VBoxContainer/TabContainer/Tags/TagsContainer/IgnoredTagsSection/ScrollContainer/IgnoredTagsList")
