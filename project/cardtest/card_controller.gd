...
var rules
var test_card_scene = "res://cardtest/clicker/Block_card.tscn"
#func _ready():
#	pass
func setup():
...
func get_random_id_from_pool(_level):
	...
	#print("selected recruit level:",sel_level)
...
func create_unit_from_id(id,_unit_level = 1):
	...
	var card_scene = load(test_card_scene)
...
func select_id_from_level(lvl):
	...
	var _cards = await data_source.get_all_cards(true) #gameone two
