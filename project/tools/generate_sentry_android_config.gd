...
func _generate_sentry_android_config():
	...
	var user_interaction = ProjectSettings.get_setting(
		"sentry/android/user_interaction_breadcrumbs", true
	)
	...
	var profiling_rate = ProjectSettings.get_setting(
		"sentry/android/profiling_session_sample_rate", "1.0"
	)
	var profiling_lifecycle = ProjectSettings.get_setting(
		"sentry/android/profiling_lifecycle", "trace"
	)
	var profiling_start = ProjectSettings.get_setting(
		"sentry/android/profiling_start_on_app_start", true
	)
	var replay_error_rate = ProjectSettings.get_setting(
		"sentry/android/session_replay_error_sample_rate", "1.0"
	)
	var replay_session_rate = ProjectSettings.get_setting(
		"sentry/android/session_replay_session_sample_rate", "0.1"
	)
	...
	metadata_lines.append(
		(
			'        <meta-data android:name="io.sentry.send-default-pii" android:value="'
			+ str(send_pii).to_lower()
			+ '" />'
		)
	)
	metadata_lines.append("")
	...
	(
		...
		. append(
			(
				'        <meta-data android:name="io.sentry.traces.user-interaction.enable" android:value="'
				+ str(user_interaction).to_lower()
				+ '" />'
			)
		)
	)
	...
	metadata_lines.append(
		(
			'        <meta-data android:name="io.sentry.attach-screenshot" android:value="'
			+ str(screenshot).to_lower()
			+ '" />'
		)
	)
	...
	metadata_lines.append(
		(
			'        <meta-data android:name="io.sentry.attach-view-hierarchy" android:value="'
			+ str(view_hierarchy).to_lower()
			+ '" />'
		)
	)
	metadata_lines.append("")
	...
	metadata_lines.append(
		(
			'        <meta-data android:name="io.sentry.traces.sample-rate" android:value="'
			+ str(traces_rate)
			+ '" />'
		)
	)
	...
	(
		...
		. append(
			(
				'        <meta-data android:name="io.sentry.traces.profiling.session-sample-rate" android:value="'
				+ str(profiling_rate)
				+ '" />'
			)
		)
	...
	metadata_lines.append(
		(
			"        <!-- Set profiling mode. For more info see "
			+ "https://docs.sentry.io/platforms/android/profiling/#enabling-ui-profiling -->"
		)
	)
	metadata_lines.append(
		(
			'        <meta-data android:name="io.sentry.traces.profiling.lifecycle" android:value="'
			+ profiling_lifecycle
			+ '" />'
		)
	)
	metadata_lines.append(
		(
			"        <!-- Enable profiling on app start. The app start profile will be "
			+ "stopped automatically when the app start root span finishes -->"
		)
	)
	(
		metadata_lines
		. append(
			(
				'        <meta-data android:name="io.sentry.traces.profiling.start-on-app-start" android:value="'
				+ str(profiling_start).to_lower()
				+ '" />'
			)
		)
	)
	...
	(
		...
		. append(
			(
				'        <meta-data android:name="io.sentry.session-replay.on-error-sample-rate" android:value="'
				+ str(replay_error_rate)
				+ '" />'
			)
		)
	)
	(
		...
		. append(
			(
				'        <meta-data android:name="io.sentry.session-replay.session-sample-rate" android:value="'
				+ str(replay_session_rate)
				+ '" />'
			)
		)
	)
