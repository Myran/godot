...
func _init() -> void:
	...
	set_description("Test Remote Config fetch_and_activate method")
...
func _execute_test() -> DebugActionResult:
	...
	assert_true(false, "FirebaseRemoteConfig.fetch_and_activate not yet implemented - see task-400")
