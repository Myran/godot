...
#
#onready var status_label = $ColorRect/Label_status
#func setup(init_args):
	#print("setup with args",init_args)
#func _ready():
	#if get_parent() == get_tree().get_root():
		#print("popup is in testscene")
		#popup()
	#$ColorRect/Label2.text = str("OS: ",OS.get_name())
	#$ColorRect/Label3.text = str("Commit: ",Engine.get_version_info()["hash"])
	#if OS.is_debug_build():
		#$ColorRect/Label.text = "Build is debug"
	#else:
		#$ColorRect/Label.text = "build is release"
#
#
#
...
##		db = ClassDB.instance("FirebaseDatabase")
##		db.connect("get_value",self,"get_value")
...
##		remote_config = ClassDB.instance("FirebaseRemoteConfig")
##		remote_config.connect("loaded",self,"remote_config_loaded")
##
##	if ClassDB.class_exists("FirebaseMessaging"):
##		print("Messaging exists")
##		messaging = ClassDB.instance("FirebaseMessaging")
##		messaging.connect("token",self,"messaging_token")
##		messaging.connect("message",self,"messaging_message")
##
...
#func _on_Button_remote_config_string_pressed():
	...
	#var rc_string = remote_config.get_string("test_parameter")
...
#func _on_Button_send_all_tracking_events_pressed():
	#print("Tracking button pressed")
		...
		#var a = ClassDB.instance("FirebaseAnalytics")
...
#func _on_Button_sign_in_anon_pressed():
	...
	#var auth_res = yield(_auth,"logged_in")
	#if auth_res =="":
...
#func _on_Button_unlink_Facebook_pressed():
	...
	#var res = yield(_auth,"account_unlinked")
	#if res == "":
...
#func _on_Button_link_Facebook_pressed():
	...
	#var link_res = yield(_auth,"account_linked")
	#if link_res == "":
...
#func _on_Auth_Apple_login_pressed():
	#print("button: apple login")
		...
		#var result= yield(self,"apple_success")
...
#func _on_Auth_Apple_link_pressed():
	...
	#var res = yield(_auth,"account_linked")
	#if res == "":
...
#func _on_Button_get_all_info_pressed():
	...
	#status_label.text = str("Name: ",_auth.user_name(),"\n","Email: ",_auth.email(),"\n","uid: ",_auth.uid(),"\n") #,"photourl: ",auth.avatar_url())
