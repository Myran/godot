...
static func save_to_project_settings(logger_instance: Logger) -> Error:
	...
	ProjectSettings.set_setting(PROJECT_SETTINGS_PREFIX + "active_tags", logger_instance._active_tags)
	ProjectSettings.set_setting(PROJECT_SETTINGS_PREFIX + "ignored_tags", logger_instance._ignored_tags)
	ProjectSettings.set_setting(PROJECT_SETTINGS_PREFIX + "show_timestamp", logger_instance._show_timestamp)
...
static func load_from_project_settings(logger_instance: Logger) -> Error:
	...
	var level = ProjectSettings.get_setting(PROJECT_SETTINGS_PREFIX + "log_level", DEFAULT_LOG_LEVEL)
	...
	var show_timestamp = ProjectSettings.get_setting(PROJECT_SETTINGS_PREFIX + "show_timestamp", DEFAULT_SHOW_TIMESTAMP)
	logger_instance.set_show_timestamp(show_timestamp)

	var show_tags = ProjectSettings.get_setting(PROJECT_SETTINGS_PREFIX + "show_tags", DEFAULT_SHOW_TAGS)
	logger_instance.set_show_tags(show_tags)

	var use_colors = ProjectSettings.get_setting(PROJECT_SETTINGS_PREFIX + "use_colors", DEFAULT_USE_COLORS)
