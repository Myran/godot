@tool
extends Node
class_name TestTagValidation

# This test validates tag validation functionality
# which will be central to our TagManager refactoring

var logger_settings = preload("res://addons/advanced_logger/logger_settings.gd")

func _ready():
	print("\n=== Running Tag Validation Tests ===")
	test_valid_tags()
	test_invalid_tags()
	test_edge_cases()
...
func test_edge_cases():
	...
	for case in edge_cases:
		var is_valid = logger_settings._is_valid_tag(case.tag)
